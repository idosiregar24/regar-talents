                    ...
                    <div class="d-lg-flex align-items-start">
                        ...
                        <div class="tab-content nxl-mega-menu-tabs-content">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                ...
                                <p class="fs-12 fw-normal text-muted text-truncate-3-line">Get started Duralux with
                                    Duralux up and running. Duralux bootstrap template docs helps you to get started
                                    with simple html codes.</p>
                            ...
                            <div class="tab-pane fade" id="v-pills-applications" role="tabpanel">
                                ...
                                <div class="d-lg-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <p class="fs-12 text-muted mb-0 text-truncate-3-line">We are ready to build
                            ...
                            <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                ...
                                <hr class="border-top-dashed" />
                                <p class="fs-13 text-muted mb-0">Need help? Contact our <a href="javascript:void(0);"
                                        class="fst-italic">support center</a></p>
                            </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                <div class="row g-4 align-items-center">
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="mt-4">
                                            <a href="mailto:flexilecode@gmail.com" class="fs-13 fw-bold">View all
                                                resources on Duralux &rarr;</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div id="carouselResourcesCaptions" class="carousel slide"
                                            ...
                                            <div class="carousel-indicators">
                                                <button type="button" data-bs-target="#carouselResourcesCaptions"
                                            ...
                                            <div class="carousel-inner rounded-3">
                                                <div class="carousel-item active">
                                                    ...
                                                    <div class="carousel-caption">
                                                        <h5 class="carousel-caption-title text-truncate-1-line">Shopify
                                                            eCommerce Store</h5>
                                                ...
                                                <div class="carousel-item">
                                                    ...
                                                    <div class="carousel-caption">
                                                        <h5 class="carousel-caption-title text-truncate-1-line">iOS
                                                            Apps Development</h5>
                                                        <p class="carousel-caption-desc">Some representative
                                                ...
                                                <div class="carousel-item">
                                                    ...
                                                    <div class="carousel-caption">
                                                        <h5 class="carousel-caption-title text-truncate-1-line">Figma
                                                            Dashboard Design</h5>
                                                        <p class="carousel-caption-desc">Some representative
                                                ...
                                                <div class="carousel-item">
                                                    ...
                                                    <div class="carousel-caption">
                                                        <h5 class="carousel-caption-title text-truncate-1-line">React
                                                            Dashboard Design</h5>
                                                        <p class="carousel-caption-desc">Some representative
                                                            placeholder content for the third slide.</p>
                                                    </div>
                                                ...
                                                <div class="carousel-item">
                                                    ...
                                                    <div class="carousel-caption">
                                                        <h5 class="carousel-caption-title text-truncate-1-line">Standup
                                                            Team Meeting</h5>
                                                        <p class="carousel-caption-desc">Some representative
                                                            placeholder content for the third slide.</p>
                                                    </div>
                                                ...
                                                <div class="carousel-item">
                                                    ...
                                                    <div class="carousel-caption">
                                                        <h5 class="carousel-caption-title text-truncate-1-line">Zoom
                                                            Team Meeting</h5>
                                                        <p class="carousel-caption-desc">Some representative
                                                            placeholder content for the third slide.</p>
                                                    </div>
                                            ...
                                            <button class="carousel-control-prev" type="button"
                                                data-bs-target="#carouselResourcesCaptions" data-bs-slide="prev">
                                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                <span class="visually-hidden">Previous</span>
                                            </button>
                                            <button class="carousel-control-next" type="button"
                                                data-bs-target="#carouselResourcesCaptions" data-bs-slide="next">
                            ...
                            <div class="tab-pane fade nxl-mega-menu-miscellaneous" id="v-pills-miscellaneous"
                                ...
                                <ul class="nav nav-tabs flex-column flex-lg-row nxl-mega-menu-miscellaneous-tabs"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#v-pills-blogs"
                                                        ...
                                                        <div class="d-lg-flex align-items-center gap-3">
                                                            ...
                                                            <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                <a href="javascript:void(0);">
                                                                    <h6 class="menu-item-heading text-truncate-1-line">
                                                                        Shopify eCommerce Store</h6>
                                                                </a>
                                                                <p
                                                                    class="fs-12 fw-normal text-muted mb-0 text-truncate-2-line">
                                                                    Lorem ipsum dolor sit amet, consectetur adipisicing
                                                                    elit. Sint nam ullam iure eum sed rerum libero quis
                                                                    doloremque maiores veritatis?</p>
                                                        ...
                                                        <div class="d-lg-flex align-items-center gap-3">
                                                            ...
                                                            <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                ...
                                                                <div class="hstack gap-2 mt-3">
                                                                    ...
                                                                    <a href="javascript:void(0);" class="fs-12">Green
                                                                        Cute</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row g-4">
                                                        ...
                                                        <div class="d-flex align-items-start gap-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p
                                                                    class="fs-12 fw-normal text-muted mb-0 text-truncate-2-line">
                                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                                                    elit Unde numquam rem dignissimos. elit Unde numquam
                                                                    rem dignissimos.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div
                                                            ...
                                                            <div class="mt-2 mt-lg-0">
                                                                <a href="javascript:void(0);"
                                                                    class="fs-13 text-primary">Learn More &rarr;</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                        <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                            ...
                                            <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                ...
                                                <div class="mt-4">
                                                    <a href="mailto:flexilecode@gmail.com"
                                                        class="fs-13 fw-bold">View all features on Duralux &rarr;</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p
                                                                    class="fs-12 fw-normal text-muted mb-0 text-truncate-2-line">
                                                                    Lorem ipsum, dolor sit amet consectetur adipisicing
                                                                    elit. Eius dolor quo commodi nisi animi error minus
                                                                    quia aliquam.</p>
